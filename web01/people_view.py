...
def index_page():
    ...
    if "action" in request.args and request.args["action"] == "people":
        return rt.render("info.html", page_list=page_list, upload_url=upload_url, info_url=info_url, cn_group=cn_group)
        ...
        return rt.render("info.html", page_list=page_list, page_people=page_people, info_url=info_url,
