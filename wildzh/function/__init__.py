...
from wildzh.function.web_func import unix_timestamp, make_static_html, make_default_static_url
from wildzh.function.web_func import make_static_url, make_static_html2
